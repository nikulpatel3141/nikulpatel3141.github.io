...
// Projects that have interactive live data components
const TRACKER_PROJECTS: Record<string, React.ReactNode> = {
...
export default async function ProjectPage({ params }: Props) {
  ...
  const tracker = TRACKER_PROJECTS[slug] ?? null;
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      {/* Live tracker (injected above prose for interactive pages) */}
      {tracker}
